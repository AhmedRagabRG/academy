...
boundaries overlap because ranges are inclusive.
...
2. **Term create/update**: transaction reads parent, validates containment and sibling ranges, writes;
   exclusion constraint is final race guard.
