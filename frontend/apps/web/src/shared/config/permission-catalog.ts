...
const settings = group("settings", "المؤسسة والإعدادات", [
  ...
  ["teams.view", "عرض الفرق", "الاطلاع على الفرق وأعضائها"],
  ["teams.create", "إنشاء فريق", "إضافة فريق جديد"],
  ["teams.update", "تعديل الفرق", "تعديل الفرق وإدارة أعضائها"],
  ["tags.view", "عرض الوسوم", "الاطلاع على وسوم المحادثات"],
  ["tags.create", "إنشاء وسم", "إضافة وسم جديد للمحادثات"],
  ["tags.update", "تعديل الوسوم", "تعديل الوسوم وتعطيلها وحذفها"],
  ["branches.view", "عرض الفروع", "الاطلاع على فروع المؤسسة"],
  ["branches.create", "إنشاء فرع", "إضافة فرع جديد"],
  [
    "branches.update",
    "تعديل الفروع",
    "تحديث أو إلغاء تفعيل الفرع وإدارة تعيينات الموظفين",
  ],
])
...
const ai = group("ai", "المساعد الذكي", [
  ...
  [
    "settings.manage",
    "تعديل إعدادات المساعد",
    "تشغيل المساعد وضبط قنواته ومعرفته",
  ],
  ["knowledge.view", "عرض قواعد المعرفة", "الاطلاع على قواعد المعرفة ومصادرها"],
  [
    "knowledge.manage",
    "إدارة قواعد المعرفة",
    "إضافة المصادر وحذفها وإعادة فهرستها",
  ],
